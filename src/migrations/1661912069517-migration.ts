...
export class migration1661912069517 implements MigrationInterface {
    name = 'migration1661912069517'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "currency" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "symbol" varchar(20) NOT NULL, "decimals" varchar NOT NULL, "contract" varchar(100) NOT NULL, "url" varchar NOT NULL)`);
